...
import com.eurekaapp.plus.SpringUtil;
import com.eurekaapp.util.HttpUtils;
...
public class DisconveryService {
	...
	public void shutdown() {
		try {
			String homepage = "http://"+com.eurekaapp.util.SystemUtil.getCurrentIp()+":"
